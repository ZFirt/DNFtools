...
namespace activitytool
{
    public class VerCode
    {
        ...
        /// 上传Bitmap验证码进行识别
        /// </summary>
        /// <param name="vcode">Bitmap验证码</param>
        /// <param name="len">验证码长度</param>
        /// <param name="strVcodeUser">平台用户名</param>
        /// <param name="strVcodePass">平台密码</param>
        /// <param name="strSoftkey">作者id</param>
        /// <returns>打码结果信息</returns>
        public static string RecByte_A(Bitmap vcode, int len, string strVcodeUser, string strVcodePass, string strSoftkey)
        {
            return recCode(Bitmap2Byte(vcode), len, 0, 0, 0, strVcodeUser, strVcodePass, strSoftkey);
        }
